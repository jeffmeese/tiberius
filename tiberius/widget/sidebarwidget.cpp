...
void SidebarWidget::createMenus()
{
  ...
  createMenuItem(mFarmMenu.get(), stringData->getString(28, 103), 40);     // Vegetables
...
void SidebarWidget::handleClearButton()
{
  cancelMenu();
  playClickSound();
}
...
void SidebarWidget::handleHouseButton()
{
  playClickSound();
  cancelMenu();
}
...
void SidebarWidget::handleRoadButton()
{
  playClickSound();
  cancelMenu();
}
...
void SidebarWidget::playClickSound()
{
